...
export function AdminRoom() {
    ...
    async function handleChackQuestionAsAnswered(questionId: string) {
                ...
                <div className="content">
                    ...
                    <div>
                        ...
                        <button onClick={toggleTheme} className={`${theme === 'light' ? 'light' : 'dark'}`}>
                            {theme === 'light' ? (
                                <img src={sunLight} alt="Tema claro" />
                            ) : (
                                <img src={moonDark} alt="Tema escuro" />
                            )}
                        </button>
                    </div>
                </div>
                            ...
                            >
                                {!question.isAnswered && (
                                    <>
                                        <button
                                            type="button"
                                            onClick={() => handleChackQuestionAsAnswered(question.id)}
                                        >
